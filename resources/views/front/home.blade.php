        ...
        <div class="row pb-3">
            ...
            <div class="col-lg-3">
                <div class="cat-card">
                    <div class="left">
                        @if($category->image != "")
                        <img src="{{asset('uploads/images/'.$category->image)}}" alt="" class="img-fluid1">
                        @else
                        <img src="{{asset('front-assets/images/cat-1.jpg')}}" alt="" class="img-fluid1">
                        @endif
                    </div>
                    <div class="right">
                        <div class="cat-data">
            ...
            <div class="col-md-3">
                <div class="card product-card">
                    <div class="product-image position-relative">
                        <a href="{{route('front.product',$product->slug)}}" class="product-img"><img class="card-img-top" src="{{asset('front-assets/images/product-1.jpg')}}" alt=""></a>
