							...
							<div class="card-header">
								...
								<div class="card-tools">
									<div class="input-group input-group" style="width: 250px;">
										<input type="text" name="table_search" value="{{Request::get('table_search')}}" class="form-control float-right" placeholder="Search">
...
@endsection
@section('customJs')
<!-- JavaScript to handle delete operation via AJAX -->
<script>
    function deleteCategory(subcategoryId) {
        if (confirm('Are you sure you want to delete this subcategory?')) {
            $.ajax({
                url: '/admin/sub-categories/' + subcategoryId, // URL to delete the category
                type: 'DELETE',
                data: {
                ...
                success: function(response) {
                    if (response.status) {
                        ...
                        $('#subcategory-row-' + subcategoryId).remove(); // Remove the category row from the table
                    } else {
